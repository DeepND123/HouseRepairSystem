...
$stmt = $conn->prepare("SELECT * FROM sellerdetails");
...
<div class="card">
  <div class="card-header">
    <h5 class="card-title">All Sellers</h5>
  </div>
...
if ($result->num_rows > 0) {
    ...
    echo ' <thead >';
    echo '  <tr>';
    echo '      <th style="width:20%;" scope="col">Seller Email</th>';
    echo '      <th style="width:15%;" scope="col">Seller Name</th>';
    echo '      <th style="width:15%;" scope="col">Full Name</th>';
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr>';
        echo '  <td><p class="image-name">' . htmlspecialchars($row['Email_Address']) . '</p></td>';
        echo '  <td><p class="image-name">' . htmlspecialchars($row['Seller_Name']) . '</p></td>';
        echo '  <td><p class="image-name">' . htmlspecialchars($row['Full_Name']) . '</p></td>'; // Fixed column
        echo '  <td><p class="image-name">' . htmlspecialchars($row['Address']) . '</p></td>'; // Fixed column
        ...
        echo '  <td>
           <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <li>
                      <a class="dropdown-item" href="approveSeller.php?id=' . htmlspecialchars($row['Email_Address']) . '">Approve</a>
                  </li>
                  <li>
                      <a class="dropdown-item" href="productreject.php?id=' . htmlspecialchars($row['Email_Address']) . '" 
