                    ...
                    <div style="position: relative;">
                         <img src="Source/main1.jpg" alt="Repair Helper Image" style="width:100%;">
                          <div style="position: absolute;top: 35%; left: -10%;color: #605678;">
                             ...
                             <button class="custom-btn" name="Find_Helper" style="width:200px" type="submit">Find A Pro</button>
                          </div>
                    </div>
            </div>
 ...
 <!--End of the header section-------------------------------------------------------------------------------------------------->
  ...
  <div class="container-fluid" style="padding-top:50px">
        <div class="row" style="align-content:center;">
            ...
            <div class="col-sm-3">
                <div class="card border-secondary" style="width:90%;">
                    <div class="card-body" align="center"><a class="dropdown-item" href="#">
                        <img class="card-img-top" src="Source/Ac.png" style="width: 100px;">
            ...
            <div class="col-sm-3">
                <div class="card border-secondary" style="width:90%;">
                    <div class="card-body" align="center"><a class="dropdown-item" href="#">
                    <img class="card-img-top" src="Source/insta.png" style="width: 100px;">
            ...
            <div class="col-sm-3" >
                <div class="card border-secondary" style="width:90%;">
                    <div class="card-body" align="center"><a class="dropdown-item" href="#">
                    <img class="card-img-top" src="Source/intallation.png" style="width: 100px;">
                    <p> Construction & Installation </p>
                    </div></a>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card border-secondary" style="width:90%;">
                    <div class="card-body" align="center"><a class="dropdown-item" href="#">
                    <img class="card-img-top" src="Source/remodel.png" style="width: 100px;">
                    <p> Home Remodeling & Improvements </p>
                    </div></a>
                </div>
            </div>
     ...
     <div style="position: relative;">
       <img src="Source/3rd.jpg" alt="Repair Helper aboutus Image" style="width:100%;">
         <div style="position: absolute;top: 35%; left: 10%;color: #605678;">
            ...
            <button class="custom-btn" name="Find_Helper" style="width:200px" type="submit">Shop Now</button>
        </div>
    </div>
...
<div class="container-fluid" style="padding-top: 80px;padding-bottom: 80px;">
 <div class="row">
     ...
     <div class="col-sm-12" style="text-align: center;color: #605678; padding-bottom: 40px;"><p class="h2">How It Works</p></div>
...
<div class="container-fluid" style="padding-top: 80px; background-color: #ebe6e8; height: 500px;">
 <div class="row">
    ...
    <div class="col-sm-12" style="text-align: center;color: #605678; padding-bottom: 40px;"><p class="h2">Our Key Features</p></div>
...
<div class="container-fluid" style="padding-top: 80px;">
 <div class="row">
    ...
    <div class="col-sm-12" style="text-align: center;color: #605678; padding-bottom: 20px;"><p class="h2">Why Choose Us?</p></div>
     ...
     <div class="col-sm-8">
             <table class="table table-borderless table align-middle">
                ...
                <tr style="">
                    <td><i class="bi bi-people-fill" style="color: #605678; font-size: 50px;"></i></td>
                    <td align="left"><p class="h5" style="color: #605678;">All Services Available</p></td>
                    <td><i class="bi bi-tags-fill" style="color: #605678; font-size: 50px;"></i></td>
                    <td align="left"><p class="h5" style="color: #605678;">Lower Prices</p></td>
                    <td><i class="bi bi-person-check-fill" style="color: #605678; font-size: 50px;"></i></td>
                    <td align="left"><p class="h5" style="color: #605678;">Trusted Experienced Technicians</p></td>
                </tr>

               <tr>
                    <td><i class="bi bi-tools" style="color: #605678; font-size: 50px;"></i></td>
                    <td align="left"><p class="h5" style="color: #605678;">Advance Technology & Equipments</p></td>
                    <td><i class="bi bi-hand-thumbs-up-fill" style="color: #605678; font-size: 50px;"></i></td>
                    <td align="left"><p class="h5" style="color: #605678;">100% Quality Guaranteed</p></td>
                    <td><i class="bi bi-sliders" style="color: #605678; font-size: 50px;"></i></td>
                    <td align="left"><p class="h5" style="color: #605678;">Customized Services</p></td>
                </tr>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a class="dropdown-item" href="s.php">Privacy Policy</a></li>
